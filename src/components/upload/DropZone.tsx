  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <h3
          className="text-[1.17rem] font-[700] text-[var(--text)] mb-2"
          style={{ fontFamily: 'var(--font-syne)' }}
        >
          {isDragOver ? 'Drop images here' : 'Drop product images here'}
        </h3>
        <p className="text-[0.92rem] text-[var(--text2)] mb-5">
        ...
        <div className="flex justify-center gap-2 flex-wrap">
          {['JPG', 'JPEG', 'PNG'].map((fmt) => (
            <span
              key={fmt}
              className="bg-[var(--bg4)] border border-[var(--line2)] rounded-[20px] px-[10px] py-1 text-[0.86rem] text-[var(--text2)]"
