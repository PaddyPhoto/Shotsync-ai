      ...
      >
        ...
        <div className="px-6 pt-6 pb-4 border-b border-[var(--line)]">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="text-[length:var(--font-xl)] font-bold tracking-[-0.5px] text-[var(--text)]" style={{ fontFamily: 'var(--font-display)' }}>
          ...
          {STEPS.map((step) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-[length:var(--font-sm)] font-semibold tracking-[0.1em] uppercase" style={{ color: step.color }}>
                    Step {step.number}
                  </p>
                  <p className="text-[length:var(--font-sm)] font-semibold text-[var(--text)] leading-tight">{step.title}</p>
                </div>
              </div>
              <p className="text-[length:var(--font-base)] text-[var(--text3)] leading-relaxed">{step.description}</p>
            </Link>
          ))}
        </div>
        ...
        <div className="px-6 pb-5 flex items-center justify-between">
          <button
            onClick={() => dismiss(true)}
            className="text-[length:var(--font-sm)] text-[var(--text3)] hover:text-[var(--text2)] transition-colors"
          >
