...
export function MobileGate({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{
      ...
      <h1 style={{ fontSize: 'var(--font-2xl)', fontWeight: 500, letterSpacing: '-.5px', color: '#1d1d1f', marginBottom: '12px' }}>
        ShotSync is built for desktop
      </h1>
      <p style={{ fontSize: 'var(--font-lg)', color: '#6e6e73', lineHeight: 1.6, letterSpacing: '-.1px', maxWidth: '280px', marginBottom: '36px' }}>
