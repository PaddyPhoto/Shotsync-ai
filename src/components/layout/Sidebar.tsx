...
const ANGLE_DOT: Record<string, string> = {
  ...
  'detail': '#ff453a', 'mood': '#ff375f', 'mood-2': '#ff375f', 'mood-3': '#ff375f',
...
export function Sidebar() {
  ...
  const SL = { fontSize: 'var(--font-xs)', fontWeight: 500, letterSpacing: '0.07em', textTransform: 'uppercase' as const, color: 'var(--text3)', padding: '0 8px', marginBottom: '3px' }
            ...
            <div style={{ padding: '8px 10px 6px', borderTop: '1.5px solid rgba(255,255,255,0.1)', marginTop: '4px' }}>
              <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '10px', overflow: 'hidden' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '7px 10px 6px', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
                  ...
                  <span style={{ fontSize: 'var(--font-xs)', color: 'var(--text3)', fontVariantNumeric: 'tabular-nums' }}>
                  ...
                  {sorted.map((c) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span style={{ fontSize: 'var(--font-sm)', flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                          {c.sku || c.label || '—'}
                        </span>
