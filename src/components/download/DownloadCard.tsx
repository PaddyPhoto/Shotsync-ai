  ...
  return (
    <div className="bg-[var(--bg2)] border border-[var(--line)] rounded-md p-5 flex items-center gap-4 hover:border-[var(--line2)] transition-colors">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[length:var(--font-md)] font-medium text-[var(--text)]">
          {marketplaceNames}
        </p>
        <p
          className="text-[length:var(--font-sm)] text-[var(--text3)] mt-[2px]"
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        {exportRecord.status === 'ready' ? (
          <>
            <span className="chip chip-ready text-[length:var(--font-sm)]">Ready</span>
