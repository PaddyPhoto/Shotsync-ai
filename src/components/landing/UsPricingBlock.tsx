...
/**
 * Self-contained US pricing block (USD) — plan cards, monthly/annual toggle,
 * checkout. Used by the standalone /us/pricing page. The US analog of
 * <PricingBlock/>; USD prices + US-specific highlight copy live here.
 */
...
const US_PLAN_UI = {
  ...
  launch: { priceUsd: 49,  annualUsd: 39,  badge: 'Launch',       badgeBg: 'rgba(0,122,255,0.10)',  badgeColor: '#0062cc', featured: false, cta: 'Start with Launch', href: '/signup?plan=launch' },
  growth: { priceUsd: 89,  annualUsd: 69,  badge: 'Most popular', badgeBg: 'rgba(48,209,88,0.18)',  badgeColor: '#30d158', featured: true,  cta: 'Start with Growth', href: '/signup?plan=growth' },
  scale:  { priceUsd: 199, annualUsd: 159, badge: 'Scale',        badgeBg: 'rgba(255,159,10,0.12)', badgeColor: '#b86e00', featured: false, cta: 'Start with Scale',  href: '/signup?plan=scale' },
} as const
...
export function UsPricingBlock() {
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', marginBottom: '52px' }}>
          ...
          <span style={{ fontSize: '14px', fontWeight: 500, letterSpacing: '-.1px', color: annual ? '#1d1d1f' : '#aeaeb2', transition: 'color .2s', display: 'flex', alignItems: 'center', gap: '7px' }}>
            Annual
            <span style={{ background: 'rgba(48,209,88,0.12)', color: '#1a8a35', fontSize: '12px', fontWeight: 500, padding: '2px 8px', borderRadius: '999px' }}>Save up to 22%</span>
          </span>
        </div>
                ...
                <div style={{ padding: '32px 28px', display: 'flex', flexDirection: 'column', flex: 1 }}>
                  ...
                  <div style={{ marginTop: 'auto', paddingTop: '24px' }}>
                    <button
                      ...
                      style={{ width: '100%', cursor: checkoutLoading === key ? 'wait' : 'pointer' }}
                    >
