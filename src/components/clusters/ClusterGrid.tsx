...
export function ClusterGrid({ clusters, onUpdate }: ClusterGridProps) {
  ...
  if (!localClusters.length) {
    return (
      <div className="text-center py-14 flex flex-col items-center gap-3">
        ...
        <p className="text-[length:var(--font-md)] font-semibold text-[var(--text)]">No clusters yet</p>
        <p className="text-[length:var(--font-sm)] text-[var(--text3)] max-w-[320px] leading-relaxed">
  ...
  return (
    <div>
      {/* Summary bar */}
      <div className="flex items-center gap-4 mb-5 text-[length:var(--font-sm)]">
