...
// The lightbox editor: live-adjusted image on the left, slider panel on the right.
// Reads/writes the per-image recipe in the session store, so each image keeps its
// own edits as you navigate and they persist with the session.
