  ...
  return (
    <div className="flex flex-col gap-2">
      <button
        ...
        className="flex items-center justify-center gap-[10px] w-full py-[9px] px-4 rounded-[8px] border border-[var(--line2)] bg-[var(--bg2)] text-[0.94rem] font-[500] text-[var(--text)] hover:bg-[var(--bg3)] transition-colors"
      >
      ...
      <div className="flex items-center gap-3 my-1">
        ...
        <span className="text-[0.85rem] text-[var(--text3)]">or</span>
        <div className="flex-1 h-px bg-[var(--line2)]" />
      </div>
    </div>
  )
