      ...
      {(Object.keys(MARKETPLACE_RULES) as MarketplaceName[]).map((id) => {
        ...
        if (isLocked) {
          return (
            ...
            >
              ...
              <p style={{ fontSize: '16px', fontWeight: 600, letterSpacing: '-.2px', marginBottom: '3px', color: 'var(--text2)' }}>
                {rule.name}
              </p>
              <p style={{ fontSize: '14px', color: '#aeaeb2', marginBottom: '4px' }}>
                {MARKETPLACE_DESCRIPTIONS[id]}
              </p>
              <p style={{ fontSize: '13px', color: 'var(--accent)', fontWeight: 600 }}>Launch plan required ↑</p>
            </button>
          )
        }
        ...
        return (
          ...
          >
            ...
            <p style={{ fontSize: '16px', fontWeight: 600, letterSpacing: '-.2px', marginBottom: '3px', color: isSelected ? palette.nameColor : '#1d1d1f' }}>
              {rule.name}
            </p>
            <p style={{ fontSize: '14px', color: '#aeaeb2', marginBottom: '12px' }}>
              {MARKETPLACE_DESCRIPTIONS[id]}
            </p>
            <div style={{ fontSize: '13px', lineHeight: 1.8, fontFamily: 'var(--font-dm-mono)', color: '#aeaeb2' }}>
