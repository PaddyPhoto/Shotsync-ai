...
export default function WhatIsShotSyncPage() {
  return (
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '72px 40px 120px' }}>
        ...
        <div style={{ background: '#fff', border: '0.5px solid rgba(0,0,0,0.08)', borderRadius: '16px', padding: '28px 32px', marginBottom: '64px' }}>
          ...
          <p style={{ fontSize: '17px', color: '#3a3a3c', lineHeight: 1.65, fontStyle: 'italic', borderLeft: '3px solid #1d1d1f', paddingLeft: '20px', margin: 0 }}>
            "The photographer just delivered 800 images and I have a CSV with 120 SKUs. How do I turn that into live product listings without spending three days doing it manually?"
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '64px' }}>
          {[
            ...
            ['Publish', 'Export pushes fully enriched listings to Shopify, Cin7, or your marketplace directly.'],
          ].map(([title, desc], i) => (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '64px' }}>
          <div style={{ background: '#fff', border: '0.5px solid rgba(0,0,0,0.08)', borderRadius: '16px', padding: '28px 24px' }}>
            ...
            <p style={{ fontSize: '14px', color: '#6e6e73', lineHeight: 1.6, marginBottom: '20px' }}>ShotSync is your entire publishing pipeline. One shoot processed once — enriched listings pushed directly to your Shopify store and Australian marketplace platforms simultaneously.</p>
            <div style={{ fontSize: '13px', color: '#4a4a4f', lineHeight: 2 }}>
              ...
              <div style={{ color: '#aeaeb2' }}>↓</div>
              <div>Shopify · THE ICONIC · Myer</div>
            </div>
          </div>
          <div style={{ background: '#fff', border: '0.5px solid rgba(0,0,0,0.08)', borderRadius: '16px', padding: '28px 24px' }}>
            ...
            <p style={{ fontSize: '14px', color: '#6e6e73', lineHeight: 1.6, marginBottom: '20px' }}>ShotSync enriches your ERP. Your ERP handles everything downstream — Shopify, THE ICONIC, Myer, David Jones. Your operations stack stays completely intact.</p>
            <div style={{ fontSize: '13px', color: '#4a4a4f', lineHeight: 2 }}>
              <div>Photoshoot + Product CSV</div>
              <div style={{ color: '#aeaeb2' }}>↓</div>
              <div style={{ fontWeight: 500 }}>ShotSync</div>
              <div style={{ color: '#aeaeb2' }}>↓</div>
              <div>Cin7 / Apparel21</div>
              <div style={{ color: '#aeaeb2' }}>↓</div>
              <div>Shopify · Myer · THE ICONIC · David Jones</div>
            </div>
          </div>
        </div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {[
                ...
                ['ERP / Inventory', 'Cin7, Apparel21 — ShotSync pushes enriched data into these'],
                ['eCommerce', 'Shopify — ShotSync pushes direct for brands without an ERP'],
                ['Marketplaces', 'THE ICONIC, Myer, David Jones — direct (small brands) or via ERP (mid-tier)'],
              ].map(([layer, tool], i) => (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '64px' }}>
          {[
            ...
            },
            {
              ...
              body: 'No ERP, no production team — just a Shopify store and a seasonal shoot. You need enriched listings in Shopify and on THE ICONIC or Myer without spending three days doing it manually. ShotSync gives a small team the workflow automation of a much larger one.',
            },
            {
              title: 'Mid-Tier Wholesale Brands',
              body: 'Selling into THE ICONIC, Myer, or David Jones through Cin7 or Apparel21? ShotSync enriches your product data before it enters the ERP — so what your retail partners receive is already compliant and publish-ready. Your ERP handles all downstream distribution.',
            },
          ].map(({ title, body }) => (
        ...
        <div style={{ background: '#fff', border: '0.5px solid rgba(0,0,0,0.08)', borderRadius: '16px', overflow: 'hidden', marginBottom: '64px' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {[
                ['Shopify', 'eCommerce', 'Live'],
                ['Cin7 Core', 'ERP', 'Live'],
                ['Apparel21', 'ERP (AU)', 'Coming soon'],
                ['THE ICONIC', 'Marketplace', 'Live'],
                ['Myer', 'Marketplace', 'Coming soon'],
                ['David Jones', 'Marketplace', 'Coming soon'],
              ].map(([platform, type, status]) => (
                <tr key={platform}>
                  <TD bold>{platform}</TD>
                  <TD>{type}</TD>
