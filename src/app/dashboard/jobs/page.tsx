  ...
  return (
    <div>
      ...
      <div className="p-7">
        ...
        {loading ? (
          <div style={{ fontSize: 'var(--font-lg)', color: 'var(--text3)' }}>Loading…</div>
        ) : fetchError ? (
          <div style={{ textAlign: 'center', padding: '64px 0' }}>
            <p style={{ fontSize: 'var(--font-lg)', color: '#ff453a', marginBottom: '8px' }}>Failed to load jobs</p>
            <p style={{ fontSize: 'var(--font-base)', color: 'var(--text3)', fontFamily: 'monospace' }}>{fetchError}</p>
          </div>
        ) : jobs.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '64px 0' }}>
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <p style={{ fontSize: 'var(--font-lg)', fontWeight: 500, color: 'var(--text)', letterSpacing: '-.2px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        {job.job_name}
                      </p>
                      <p style={{ fontSize: 'var(--font-md)', color: 'var(--text3)', marginTop: '2px' }}>
                    ...
                    {/* Date */}
                    <p style={{ fontSize: 'var(--font-md)', color: 'var(--text3)', flexShrink: 0 }}>
                    ...
                    <span style={{
                      flexShrink: 0,
                      fontSize: 'var(--font-md)', fontWeight: 500,
                  ...
                  <div style={{ padding: '0 14px 0 0', flexShrink: 0 }}>
                    {isConfirming ? (
                      <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                        <span style={{ fontSize: 'var(--font-md)', color: '#ff3b30' }}>Delete?</span>
                        <button
                          onClick={() => handleDelete(job.id)}
                          style={{ fontSize: 'var(--font-md)', fontWeight: 500, color: '#fff', background: '#ff3b30', border: 'none', borderRadius: '6px', padding: '3px 8px', cursor: 'pointer' }}
                        >
                          Yes
                        </button>
                        <button
                          onClick={() => setConfirmDeleteId(null)}
                          style={{ fontSize: 'var(--font-md)', color: 'var(--text3)', background: 'transparent', border: 'none', padding: '3px 4px', cursor: 'pointer' }}
                        >
                          Cancel
                        </button>
                      </div>
