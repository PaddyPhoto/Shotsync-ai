    ...
    <div>
      ...
      <div className="p-7">
        <div className="mb-7">
          ...
          {isDemoMode && (
            <div className="mt-3 inline-flex items-center gap-2 text-[0.89rem] text-[var(--accent)] bg-[rgba(232,217,122,0.08)] border border-[rgba(232,217,122,0.2)] px-3 py-[5px] rounded-sm">
        ...
        {!job?.shopify_connected && !isDemoMode && (
          <div className="flex items-center gap-3 mb-6 px-4 py-3 rounded-sm border border-[var(--line)] bg-[var(--bg3)]">
            ...
            <p className="text-[0.92rem] text-[var(--text3)]">
