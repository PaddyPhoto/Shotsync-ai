    ...
    <div>
      ...
      <div className="p-7">
        ...
        <div className="flex flex-col items-center text-center py-8 mb-8">
          ...
          <h1
            className="text-[length:var(--font-3xl)] font-[700] tracking-[-0.5px] text-[var(--text)] mb-2"
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="stat-card">
            ...
            <p className="stat-value text-[length:var(--font-2xl)]">{formatBytes(totalSize)}</p>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-[length:var(--font-base)] text-[var(--text3)] mb-3">
              All images are renamed using the structured format:
            </p>
            <div className="bg-[var(--bg3)] border border-[var(--line2)] rounded-sm px-4 py-3 text-[length:var(--font-sm)] mb-4" style={{ fontFamily: 'var(--font-dm-mono)' }}>
            ...
            <div className="flex flex-col gap-1 text-[length:var(--font-base)]" style={{ fontFamily: 'var(--font-dm-mono)' }}>
              {[
