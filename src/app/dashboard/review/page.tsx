...
function ExportPanel({
  ...
  const Toggle = ({ on, onToggle, label, sub }: { on: boolean; onToggle: () => void; label: string; sub?: string }) => (
    <label className="flex items-center gap-3 cursor-pointer">
      ...
      <span className="text-[length:var(--font-sm)] text-[var(--text2)]">{label}{sub && <span className="text-[var(--text3)] ml-1">{sub}</span>}</span>
    </label>
  )
      ...
      <div className="flex-1 min-h-0 grid grid-cols-[420px_260px_1fr] divide-x divide-[var(--line)] overflow-hidden">
        ...
        >
          ...
          <div className="flex-shrink-0 pb-5 border-b border-[var(--line)]">
            <p className="text-[length:var(--font-base)] font-semibold text-[var(--text3)] uppercase tracking-wide mb-3">Output format</p>
            ...
            <div className="mt-2 min-h-[18px]">
              {exportMode === 'folder' && <p className="text-[length:var(--font-base)] text-[var(--text3)]">Chrome and Edge only</p>}
            ...
            {exportMode === 'folder' && (
              <div className="flex items-center gap-2 mt-2">
                ...
                {folderName
                  ...
                  : <span className="text-[length:var(--font-base)] text-[var(--text3)]">{fsaSupported ? 'None selected' : 'Requires Chrome/Edge'}</span>
                }
              </div>
            )}
          </div>
          ...
          <div className="flex-shrink-0 py-5 border-b border-[var(--line)]">
            <p className="text-[length:var(--font-base)] font-semibold text-[var(--text3)] uppercase tracking-wide mb-4">Options</p>
          ...
          <div className="flex-shrink-0 pt-5">
            <div className="flex items-center justify-between mb-3">
              <p className="text-[length:var(--font-base)] font-semibold text-[var(--text3)] uppercase tracking-wide">File naming</p>
            </div>
            ...
            <p className="text-[length:var(--font-base)] text-[var(--text3)] leading-loose flex flex-wrap gap-x-1">
